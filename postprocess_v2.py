...
class output_generator():
    ...
    def generate(self):
        ...
        io.imsave(os.path.join(self.prediction_path, f't2r_{self.checkpoint_idx}.tif'), self.t2r.astype(np.float32), check_contrast=False)
        io.imsave(os.path.join(self.prediction_path, f'r2t_{self.checkpoint_idx}.tif'), self.r2t.astype(np.float32), check_contrast=False)
